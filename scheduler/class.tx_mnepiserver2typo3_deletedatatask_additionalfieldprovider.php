...
/**
 * Aditional fields provider class for usage with the DeleteDataTask
 *
 ...
 * $Id$
 */
class tx_mnepiserver2typo3_DeleteDataTask_AdditionalFieldProvider implements tx_scheduler_AdditionalFieldProvider {
